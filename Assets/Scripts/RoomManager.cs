...
public class RoomManager : MonoBehaviour
{
    ...
    private int[,] roomGrid; // 2D array to represent the room grid
    ...
    private void Start()
    {
        ...
        // Start the first room at the center of the grid
    ...
    {
        // Find and return the Room script of the room at the specified index
